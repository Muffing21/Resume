...
void mod_inverse(mpz_t i, mpz_t a, mpz_t n) {
    ...
    mpz_inits(r, r_prime, t, t_prime, q, temp, i);
    mpz_set(r, n);
    mpz_set(r_prime, a);
    mpz_set(t, 0);
    ...
    mpz_set(i, t);
    mpz_clears(r, r_prime, t, t_prime, q, temp, i);
    return;
}
...
void pow_mod(mpz_t out, mpz_t base, mpz_t exponent, mpz_t modulus) {
    ...
    mpz_inits(v, p, temp, store_value_one);
    mpz_set_ui(v, 1);
    mpz_set(p, base);
    while (mpz_cmp(exponent, 0) > 0) {
...
bool is_prime(mpz_t n, uint64_t iters) {
    ...
    mpz_inits(r, j, temp, s, y, temp2, store_value_two);
    ...
    mpz_clears(r, j, temp, s, y, temp2, store_value_two);
    return true;
}
