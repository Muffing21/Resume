class ingredients extends Phaser.Scene{
    ...
    create(data){
        ...
        this.vanilla=this.physics.add.image(200,50,'vanilla').setScale(this.AVATAR_SCALE).setInteractive({draggable: true});

        this.bp=this.physics.add.image(200,50,'bp').setScale(this.AVATAR_SCALE).setInteractive({draggable: true});
        
        this.soda=this.physics.add.image(200,50,'soda').setScale(this.AVATAR_SCALE).setInteractive({draggable: true});
