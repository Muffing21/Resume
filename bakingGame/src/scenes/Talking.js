class Talking extends Phaser.Scene {
    ...
    create() {
        ...
        this.Gorgon = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'Gorgon').setOrigin(0, 1);
        this.You = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'You').setOrigin(0, 1);
        // start dialog
        this.typeText();   
